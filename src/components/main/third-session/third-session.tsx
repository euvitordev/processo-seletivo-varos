  ...
  return (
    <div className="mt-52 flex w-full items-start justify-between max-xl:gap-12 max-md:mt-20 max-md:flex-col">
      ...
      <div className="flex w-full max-w-xl flex-col max-xl:mt-10">
        ...
        <div className="mt-20 rounded-[36px] bg-gradient-to-r from-[#4D5358] to-transparent to-70% p-0.5">
          <div className=" flex items-center justify-center rounded-[36px] bg-[#131313] px-24 py-4 max-xl:p-4 max-md:p-4">
